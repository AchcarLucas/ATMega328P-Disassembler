...
#define FMUL(x) ((x >> 8) == 0b000000110 and ((x >> 4) & std::bitset<16>(0b1000)) == 0x00 and (x & std::bitset<16>(0b1000)) == 0x01); // 0000 0011 0ddd 1rrr
#define FMULS(x) ((x >> 8) == 0b00000011 and ((x >> 4) & std::bitset<16>(0b1000)) == 0x01 and (x & std::bitset<16>(0b1000)) == 0x00); // 0000 0011 1ddd 0rrr
#define FMULSU(x) ((x >> 8) == 0b00000011 and ((x >> 4) & std::bitset<16>(0b1000)) == 0x01 and (x & std::bitset<16>(0b1000)) == 0x01); // 0000 0011 1ddd 1rrr
...
#define LAS(x) ((x >> 9) == 0b1001001 and (x & std::bitset<16>(0b1111)) == 0b0111); // 1001 001r rrrr 0111

// LD – Load Indirect from Data Space to Register using Index X
#define LD_X_I(x) ((x >> 9) == 0b1001000 and (x & std::bitset<16>(0b1111)) == 0b0111); // 1001 000d dddd 1100
...
#define LD_Y_IV(x) ((x >> 14) == 0b10 and ((x >> 9) & std::bitset<16>(0x01)) == 0x00 and ((x >> 3) & std::bitset<16>(0x01)) == 0x01); //10q0 qq0d dddd 1qqq
...
#define LD_Z_IV(x) ((x >> 14) == 0b10 and ((x >> 9) & std::bitset<16>(0x01)) == 0x00 and ((x >> 3) & std::bitset<16>(0x01)) == 0x00); //10q0 qq0d dddd 0qqq

#define LDI(x) ((x >> 12) == 0b1110); // 1110 KKKK dddd KKKK

#define LDS_32(x) ((x >> 25) == 0b1001000 and ((x >> 16) & std::bitset<16>(0b1111)) == 0x0); // 1001 000d dddd 0000 kkkk kkkk kkkk kkkk
...
#define MULSU(x) ((x >> 7) == 0b000000110 and ((x >> 7) & std::bitset<16>(0b1111)) == 0x0 and ((x >> 3) & std::bitset<16>(0x01)) == 0x0); // 0000 0011 0ddd 0rrr
...
#define SBRS(x) ((x >> 9) == 0b1111111 and (x & std::bitset<16>(0b1000)) == 0b1000);; // 1111 111r rrrr 0bbb
...
#define SER(x) ((x >> 8) == 0b11101111 and (x & std::bitset<16>(0b1111)) == 0b1111); // 1110 1111 dddd 1111
